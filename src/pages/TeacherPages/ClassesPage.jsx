...
import { Search, Plus, Filter, Clock, History, Grid3X3 } from "lucide-react";
...
const ClassesPage = () => {
  ...
  useEffect(() => {
    const filtered = classes.filter((classItem) => {
      ...
      const matchesTab =
        activeTab === "all" || classItem.category === activeTab;
      ...
      <div className="space-y-6">
        ...
        <div className="mt-5 flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="p-2">
            ...
            <p className="text-sm text-muted dark:text-emerald-500">
              Manage your class rosters, grades, and engagement
            </p>
          </div>
        ...
        >
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger
              value="current"
              className="text-white data-[state=active]:bg-white data-[state=active]:text-black cursor-pointer px-2 sm:px-3"
            >
              <div className="flex items-center justify-center gap-2">
                <Clock className="h-4 w-4 flex-shrink-0" />
                <span className="hidden sm:inline text-xs sm:text-sm">Current Classes</span>
              </div>
            </TabsTrigger>
            <TabsTrigger
              value="past"
            ...
            >
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="hidden sm:inline text-xs sm:text-sm">Past Classes</span>
              </div>
            </TabsTrigger>
            <TabsTrigger
              value="all"
            ...
            >
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="hidden sm:inline text-xs sm:text-sm">All Classes</span>
              </div>
            </TabsTrigger>
          </TabsList>
